...
class Kalender extends Component {
    render() {
        return (
            <div>
                <MyNav type="mykalender">Kalender Hari<br />Lingkungan Hidup</MyNav>
                <div className="row">
                    <MyBox type="col-md-6 mx-auto" >
                        ...
                        <h5 className="text-center">
                            <i>
                                "Menyelamatkan lingkungan hidup dimulai dari tindakan awalmu dengan membersihkan dan melestarikan."
                            </i>
                        </h5>
                        <br />
                        <br />
